...
export function PhotoGallery() {
  ...
  return (
    <section style={{ backgroundColor: '#F5F0E8' }} className="py-16 overflow-hidden">
      ...
      {/* Welcome text */}
      <div className="text-center px-3 max-w-sm mx-auto mb-12">
        <h2
          style={{
        ...
        >
          We warmly invite you to celebrate our wedding day with us in the beautiful town of Ronda, Andalusia. We look forward to sharing this unforgettable moment{' '}
          <span style={{ color: '#B8966E' }}>with our most special people.</span>
        </p>
      </div>
